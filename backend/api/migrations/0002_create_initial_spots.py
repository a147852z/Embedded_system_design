...
def create_initial_spots(apps, schema_editor):
    ...
    spots = [
        ...
        {'id': 'A-2', 'label': 'A-2', 'status': 'AVAILABLE', 'is_ev': False, 'is_priority': False, 'distance_raw': 8, 'floor': 1, 'section': 'A', 'plate_number': 'ABC-5678'},
        {'id': 'A-3', 'label': 'A-3', 'status': 'AVAILABLE', 'is_ev': False, 'is_priority': False, 'distance_raw': 7, 'floor': 1, 'section': 'A'},
        {'id': 'A-4', 'label': 'A-4', 'status': 'AVAILABLE', 'is_ev': False, 'is_priority': True, 'distance_raw': 10, 'floor': 1, 'section': 'A', 'abnormal_reason': '模擬異常'},
    ]
